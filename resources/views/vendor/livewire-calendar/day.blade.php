...
<div
    ...
    <div
        ...
        <div
            ...
            @endif
            class="w-full h-full p-2 {{ $dayInMonth ? $isToday ? 'bg-yellow-100' : ' bg-white ' : 'bg-gray-100' }} flex flex-col hover:bg-gray-50 transition-colors cursor-pointer">
            ...
            <div class="flex items-center">
                ...
                <p class="text-xs text-gray-600 ml-4">
                    @if($events->isNotEmpty())
                        {{ $events->count() }} {{ Str::plural('chore', $events->count()) }}
                    @endif
                </p>
            </div>
